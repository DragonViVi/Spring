...
public class ProcessorDemo {
    ...
    private ItemProcessor<Template, Template> idFilterProcessor;
//


    public ProcessorDemo(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory, ItemProcessor<Template, Template> nameLowerProcessor, ItemProcessor<Template, Template> idFilterProcessor) {
        this.jobBuilderFactory = jobBuilderFactory;
        this.stepBuilderFactory = stepBuilderFactory;
        this.nameLowerProcessor = nameLowerProcessor;
        this.idFilterProcessor = idFilterProcessor;
    }
